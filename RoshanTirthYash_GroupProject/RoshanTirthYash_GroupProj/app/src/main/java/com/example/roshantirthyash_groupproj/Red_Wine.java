...
public class Red_Wine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fd1.setWine_name("Merlot");
        fd1.setWine_image(R.drawable.red_wine_17);
        ...
        fd2.setWine_name("Casillero");
        fd2.setWine_image(R.drawable.red_wine_15);
        fd2.setWine_star(4f);
        ...
        fd3.setWine_name("Quilt");
        fd3.setWine_image(R.drawable.red_wine_16);
        fd3.setWine_star(5f);
        fd3.setWine_price(8);
        ...
        fd4.setWine_name("Apothic Red");
        fd4.setWine_image(R.drawable.red_wine_7);
        ...
        fd5.setWine_name("Kita");
        fd5.setWine_image(R.drawable.red_wine_4);

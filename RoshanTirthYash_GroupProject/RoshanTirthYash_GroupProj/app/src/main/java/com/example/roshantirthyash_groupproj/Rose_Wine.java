...
public class Rose_Wine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fd1.setWine_name("Jolies Filles");
        fd1.setWine_image(R.drawable.rose_wine_16);
        ...
        fd2.setWine_name("Oak Farm");
        fd2.setWine_image(R.drawable.rose_wine_6);
        fd2.setWine_star(4f);
        ...
        fd3.setWine_name("Hampton Water");
        fd3.setWine_image(R.drawable.rose_wine_10);
        fd3.setWine_star(5f);
        fd3.setWine_price(8);
        ...
        fd4.setWine_name("Dark Horse");
        fd4.setWine_image(R.drawable.rose_wine_11);
        ...
        fd5.setWine_name("Dark Horse");
        fd5.setWine_image(R.drawable.rose_wine_12);
